	...
	SZ.引擎=['默认','原神','百度','搜狗','极速','慕名','思必','有道','阿里','腾讯','火山','呱呱','讯飞','讯配','微软','微译','微硬','马克','大声','小声','同花','混合']
	
	function 切换主播(lx) {
		if (lx) {设置('主播类型: ' + lx)}
		VoiceLX = lx || VoiceLX
		switch (VoiceLX) {
			case '默认':选择主播(0, 24, 24, 2, 49, 183);break;
			case '原神':选择主播(24, 24, 24, 7, 49, 183);break;
			case '百度':选择主播(0, 0, 0, 2, 13, 3);break;
			case '搜狗':选择主播(14, 14, 14, 17, 36, 13);break;
			case '极速':选择主播(13, 13, 13, 17, 36, 13);break;
			case '思必':选择主播(16, 16, 16, 33, 0, 30);break;
			case '有道':选择主播(27, 27, 27, 29, 38, 30);break;
			case '阿里':选择主播(2, 2, 2, 17, 2,18);break;
			case '腾讯':选择主播(1, 1, 1, 1, 0, 19);break;
			case '火山':选择主播(23, 23, 23, 26, 20, 34);break;
			case '呱呱':选择主播(15, 15, 15, 23, 0, 22);break;
			case '慕名':选择主播(12, 12, 12, 10, 13, 7);break;
			case '讯飞':选择主播(10, 10, 10, 38, 4, 15);break;
			case '讯配':选择主播(11, 11, 11, 15, 0, 17);break;
			case '微硬':选择主播(7, 7, 7, 6, 10, 18);break;
			case '微软':选择主播(9, 9, 9, 6, 10, 18);break;
			case '微译':选择主播(5, 5, 5, 6, 10, 18);break;
			case '马克':选择主播(8, 8, 8, 6, 10, 18);break;
			case '大声':选择主播(6, 6, 6, 14, 1, 16);break;
			case '小声':选择主播(28, 28, 28, 14, 1, 16);break;
			case '同花':选择主播(19, 19, 19, 0, 8, 1);break;
			case '混合':选择主播(20, 21, 22, 1, 11, 0);break;
		}
	}
	...
	SZ.主播=[
		...
		'微译(微软-blob-加密)|微软|com.microsoft.azure|https://eastus.api.speech.microsoft.com/cognitiveservices/voices/list' ,
		...
		'讯配(讯飞-mp3-加密)|讯配|peiyin.xunfei.cn|http://peiyin.xunfei.cn/video-api/asset/qry_speakers' ,
		...
		'慧言(慧言-base64)|慧言|ai.huiyan-tech.com|https://api.huiyan-tech.com/platform/v1/voice/tts/list' ,
	...
	SZ.源站 = [
		...
		'<hr>',
		'微软',
		'azure|https://azure.microsoft.com/zh-cn/products/ai-services/text-to-speech/',
		...
		'必译|http://cn.bing.com/translator/',
		...
		'宝宝|https://peiyinbaobao.com/index/peiyin.html',
		'悦比特|https://www.yuebit.com.cn/texttospeech/gensound.html',
		'(列表)|https://www.yuebit.com.cn/texttospeech/soundsample.html?languages=cmn-CN',
		'<hr>',
		'搜狗|https://ai.sogou.com/',
		...
		'列表|https://www.volcengine.com/docs/6561/97465 ',
		...
		'序猴|https://openapi.moyin.com/pages/speech-synthesis-online',
		...
		'慧言|https://ai.huiyan-tech.com/#/product/tts-online',
	...
	function 示例() {
		...
		var url = Road+'/文本/小说/恐怖小说900本/',
			kw = ['她极为详尽地叙述着。“那座古宅是在山顶部，还是在半山腰？”“半山腰靠上一点！”“你知不知道古宅的来历？”“这个，我不清楚，不过远远望去，那古宅显得极其苍老，像一个老态龙钟的老人一样蹲在山上！”说到这里，她已哽咽了起来。“平时，出现这种情况的时候，他都是在多长时间后回来的？”我尽量舒缓语气地问道。“两三天吧，也有更长的时候，有一次，七天后他才回来的，这是最长的时间了，可……可这一次，已……已经过去了一个月了！”她的眼睛变得通红，情绪开始变得激动起来。“你别怕！我想他还不至于出现什么不测的，也许明天就能回来的！”“根本不可能的，你不知道的，南山那里只有一座古宅，他要是没去那里又会去哪里？”他冲动地说着。“你去那里找过吧？”我问道。“没有！到南山上面的古宅只有一条路的，而且很陡峭，坎坷不平，我叫了家里唯一的仆人塔斯去寻里找他，可是，塔斯去了后竟然跟他一样再也没有回来，我非常的害怕，不知道到底出了什么事情，终于忍受不住那种恐惧的煎熬，所以我才来找你的！”“你就那么肯定，他一定进了那个古宅么？”我忍不住问道。“他生气的时候喜欢找安静的地方发泄的，我很了解他的性格的，他要是没有去那座古宅又会去哪里呢？再说，那座山上也只有那么一座古宅，其它的地方都是光秃秃的古头。”', url + '短篇/洞穴.txt', url + '中篇/小涛鬼话完整版.txt', url + '长篇/血色天堂.txt', url + '其他/丧尸之末日的背叛[校对版].txt', url + '集/李碧華短篇怪異小說.txt']
		Exa++
		if (Exa > 6) {
			Exa = 0
		}
	...
	SZ.讯配={'悦小妮 [甜美女声]':'130147','聆玉言 [知性女声]':'607538082','聆小瑜 [温柔女声]':'130146','聆小瑶 [甜美女声]':'130044','聆小璇 [清甜女声]':'130050','聆小璐 [灵动女声]':'130049','聆小琬 [恬静女声]':'130047','聆小璎 [温婉女声]':'130048','聆小岚 [亲和女声]':'130145','聆小芸 [甜美女声]':'130178','聆小珊 [新闻女声]':'130110','聆小臻 [直播女声]':'130124','聆佑佑 [呆萌女童]':'540617550','聆天明 [高冷男声]':'130097','聆明泽 [率性男声]':'130100','聆关山 [成熟男声]':'130099','聆飞晨 [情感男声]':'130056','聆飞哲 [知性男声]':'130057','聆飞瀚 [磁性男声]':'130055','聆飞泓 [情感男声]':'130098','聆飞远 [电竞男声]':'130103','聆飞皓 [直播男声]':'130123','聆伯松 [苍老男声]':'130142','思婷 [甜美女声]':'633870173','子悠 [甜美女声]':'130139','一菲 [轻柔女声]':'130012','小露 [娇俏女声]':'130009','千雪 [优雅女声]':'130008','小果 [大气女声]':'130102','秀英 [苍老女声]':'520753808','淑芬 [成熟女声]':'130150','桂花婶 [成熟女声]':'130148','晓晗 [自然女声]':'130140','希涵 [高冷女声]':'130004','嘉欣 [热情女声]':'130018','小娟 [知性女声]':'130013','小婉 [深情女声]':'20069','小英 [高雅女声]':'130021','小雅 [自然女声]':'20062','小薛 [激动女声]':'65320','小南 [亲切女声]':'65340','程程 [荒诞女声]':'65080','瑶瑶 [轻浮女声]':'65360','小璇 [可爱女声]':'60025','小媛 [中英双语]':'130019','诺诺 [邻家女孩]':'130113','小燕 [新闻女声]':'60020','玲姐姐 [明星主播]':'60140','百合仙子 [明星主播]':'62060','娱小妹 [甜美女声]':'130149','子轩 [时尚男声]':'561470586','楚哥 [时尚男声]':'523064535','段哥 [幽默男声]':'130141','七哥 [自然男声]':'130164','超哥 [亲切男声]':'130020','阿森 [阳光男声]':'130035','皓宇 [率性男声]':'130002','顾辉 [知性男声]':'130023','辉叔 [成熟大叔]':'65250','野哥 [中年大叔]':'65270','水哥 [冷酷男声]':'130039','管哥 [深沉男声]':'130016','小钟 [磁性男声]':'130011','小鹏 [知性男声]':'20082','宣哥 [情感男声]':'20067','小俊 [冲动男声]':'65070','小光 [阳光男声]':'65110','小洋 [冷漠男声]':'65010','老马 [中年男声]':'60150','小华 [青年男声]':'62010','小宇 [机械男声]':'15675','宝哥 [明星主播]':'65230','韦香主 [明星主播]':'62070','飞碟哥 [明星主播]':'130040','大圣 [明星主播]':'130033','楠楠 [可爱男童]':'60130','宁宁 [可爱男童]':'70002','豆豆 [可爱男童]':'130015','小桃丸 [可爱女童]':'60120','萌小新 [动漫人物]':'60170','宝儿 [四川女声]':'130037','苏小曦 [苏州女声]':'130036','子芯 [安徽女声]':'130034','阮灵 [上海女声]':'130032','小包 [内蒙男声]':'20077','小肥 [安徽男声]':'20076','小月 [粤语女声]':'60027','小王 [湖北男声]':'20075','小东 [山东女声]':'20074','晓倩 [东北女声]':'68040','小强 [湖南男声]':'68010','小坤 [河南男声]':'68030','小蓉 [四川女声]':'68060','小莹 [陕西女声]':'68080','玉儿 [台湾女声]':'68120','小梅 [广东女声]':'10003','史蒂夫 [英语男声]':'69030','琳赛 [英语女声]':'20066','约翰 [英语男声]':'69010','凯瑟琳 [英语女声]':'69020'}
	...
	SZ.问问={'小杰通用男声':'billy','小娜温柔女声':'cissy','智玲台湾女声':'tina','小灵可爱童声':'lucy','小雪通用女声':'emily','阿朵粤语女声':'dora','小e英文女声':'angela','慕容古风男声':'murong','小虎天真童声':'xiaohu','伯光苍老男声':'boguang','张一甲甲子光年':'zhangyijia','艾诚爱问人物':'aicheng','徐志斌见识科技':'xuzhibin','杨静新智源科技':'yangjing','炫姐姐深圳湾':'xuanjiejie'}
	
	SZ.灵云={'逍遥威':'cn_xiaoyaowei','沉稳威':'cn_chenwenwei','新闻威':'cn_xinwenwei','自然宁':'cn_ziranning','舒缓钰':'cn_shuhuanyu','新闻菡':'cn_xinwenhan','甜美茹':'cn_tianmeiru','自然真':'cn_ziranzhen','大气铭':'cn_daqiming','粤语雯':'yue_ziranwen','闽南琴':'nan_ziranqin'}
	
	SZ.慧言={'思杰 [沉稳男声]':'sijie','思越 [标准男声]':'siyue','思进 [标准男声]':'sijin','思轩 [阳光男声]':'sixuan','正朗 [咨讯男声]':'zhenglang','正宇 [客服男声]':'zhengyu','潇阳 [直播男声]':'xiaoyang','潇博 [直播男声]':'xiaobo','智宇 [可爱男童]':'zhiyu','晓夕 [活泼女声]':'xiaoxi','晓悦 [活泼女声]':'xiaoyue','晓慧 [标准女声]':'xiaohui','思若 [标准女声]':'siruo','雅清 [标准女声]':'yaqing','静涵 [温柔女声]':'jinghan','美慧 [温柔女声]':'meihui','美智 [亲和女声]':'meizhi','美心 [亲和女声]':'meixin','麦琪 [直播女声]':'maiqi','麦妮 [直播女声]':'maini','麦琳 [直播女声]':'mailin','海小棠 [甜美女声]':'haixiaotang'}
	...
	SZ.微软={'晓晓 [清澈女声](Edge)':'zh-CN-XiaoxiaoNeural','晓伊 [娇俏女声](Edge)':'zh-CN-XiaoyiNeural','晓辰 [自然女声](Azure)':'zh-CN-XiaochenNeural','晓函 [高雅女声](Azure)':'zh-CN-XiaohanNeural','晓梦 [气质女声](Azure)':'zh-CN-XiaomengNeural','晓墨 [情感女声](Azure)':'zh-CN-XiaomoNeural','晓秋 [成熟女声](Azure)':'zh-CN-XiaoqiuNeural','晓睿 [严厉女声](Azure)':'zh-CN-XiaoruiNeural','晓萱 [知性女声](Azure)':'zh-CN-XiaoxuanNeural','晓颜 [温暖女声](Azure)':'zh-CN-XiaoyanNeural','晓甄 [甜美女声](Azure)':'zh-CN-XiaozhenNeural','晓双 [活泼女童](Azure)':'zh-CN-XiaoshuangNeural','晓悠 [可爱女童](Azure)':'zh-CN-XiaoyouNeural','云希 [清朗男声](Edge)':'zh-CN-YunxiNeural','云健 [率性男声](Edge)':'zh-CN-YunjianNeural','云夏 [少年正太](Edge)':'zh-CN-YunxiaNeural','云扬 [知性男声](Edge)':'zh-CN-YunyangNeural','云枫 [青年男声](Azure)':'zh-CN-YunfengNeural','云皓 [情感男声](Azure)':'zh-CN-YunhaoNeural','云野 [磁性男声](Azure)':'zh-CN-YunyeNeural','云泽 [成熟男声](Azure)':'zh-CN-YunzeNeural'}
	
	
	SZ.马克={'晓晓 [通用女生]':'1504','晓伊 [阅读女声]':'1505','晓辰 [通用女声]':'1501','晓函 [通用女声]':'1502','晓梦 [通用女声]':'1509','晓墨 [通用女声]':'1510','晓秋 [演讲女声]':'1513','晓睿 [感性女声]':'1516','晓萱 [解说女声]':'1519','晓颜 [故事女声]':'1520','晓甄 [通用女声]':'1517','晓双 [儿童女孩]':'1522','晓悠 [儿童女孩]':'1523','云希 [短视频男声]':'1503','云健 [播音男声]':'1506','云夏 [少年男声]':'1507','云扬 [播音男声]':'1508','云枫 [通用男声]':'1511','云皓 [通用男声]':'1512','云野 [新闻男声]':'1515','云泽 [演讲男声]':'1518'}
	
	SZ.原神 = ['「女士」','女士','浮游水蕈兽·元素生命','珊瑚宫心海','羽生田千鹤','纯水精灵？','回声海螺','八重神子','大慈树王','鹿野奈奈','九条裟罗','雷电将军','罗莎莉亚','迪娜泽黛','神里绫华','玛格丽特','萨赫哈蒂','深渊法师','凯瑟琳','爱德琳','阿贝多','菲谢尔','柊千里','埃洛伊','阿娜耶','海妮耶','海芭夏','芙宁娜','迪希雅','娜维娅','伊迪娅','珐露珊','久岐忍','绮良良','艾莉丝','坎蒂丝','塞塔蕾','琳妮特','玛乔丽','凝光','嘉玛','夜兰','申鹤','丽莎','温迪','珊瑚','迈蒙','柯莱','莎拉','百闻','莺儿','妮露','甘雨','云堇','慧心','优菈','莫娜','行秋','宛烟','刻晴','阿祇','北斗','雷泽','辛焱','琴','悦','荧','萍姥姥','纳西妲','迪奥娜','爱贝尔','诺艾尔','芭芭拉','莱依拉','欧菲妮','夏洛蒂','早柚','多莉','瑶瑶','砂糖','长生','拉齐','安柏','派蒙','阿圆','烟绯','宵宫','可莉','胡桃','香菱','七七','艾文','「白老先生」','「大肉丸」','「博士」','陆行岩本真蕈·元素生命','塔杰·拉德卡尼','鹿野院平藏','笼钓瓶一心','掇星攫辰天君','留云借风真君','戴因斯雷布','荒泷一斗','莱欧斯利','那维莱特','克列门特','莫塞伊思','德沃沙克','九条镰治','佐西摩斯','达达利亚','神里绫人','埃尔欣根','天目十五','伊利亚斯','艾尔海森','阿尔卡米','枫原万叶','阿巴图伊','蒂玛乌斯','深渊使徒','常九爷','田铁嘴','吴船长','式大将','流浪者','迪卢克','艾伯特','丹吉尔','查尔斯','埃舍尔','阿佩普','阿洛瓦','迈勒斯','玛塞勒','萨齐因','西拉杰','克罗索','提纳里','塞琉斯','纳比尔','舒伯特','埃勒曼','沙扎曼','拉赫曼','杜拉夫','久利须','阿扎尔','巴达维','斯坦利','霍夫曼','阿拉夫','毗伽尔','班尼特','旁白','五郎','老孟','天叔','石头','言笑','托马','博来','康纳','拉齐','安西','卡维','埃德','赛诺','哲平','阿晃','钟离','博易','白术','嘉良','元太','昆钧','阿守','埃泽','知易','奥兹','松浦','重云','上杉','恕筠','凯亚','林尼','龙二','恶龙','米卡','托克','魈','空','anzai']
	
	SZ.火译={'影视男声':'zh_male_xiaoming','主播男声':'zh_male_zhubo','主播女声':'zh_female_zhubo','清新女声':'zh_female_qingxin','故事女声':'zh_female_story'}
	
	SZ.火山={'灿灿2.0':'BV700_V2','通用女声2.0':'BV001_V2','灿灿':'BV700','超自然音色-梓梓2.0':'BV406_V2','超自然音色-梓梓':'BV406','超自然音色-燃燃2.0':'BV407_V2','超自然音色-燃燃':'BV407','通用女声':'BV001','通用男声':'BV002','擎苍':'BV701','阳光青年':'BV123','反卷青年':'BV120','通用赘婿':'BV119','古风少御':'BV115','霸气青叔':'BV107','质朴青年':'BV100','温柔淑女':'BV104','开朗青年':'BV004','甜宠少御':'BV113','儒雅青年':'BV102','甜美小源':'BV405','亲切女声':'BV007','知性女声':'BV009','诚诚':'BV419','童童':'BV415','亲切男声':'BV008','译制片男声':'BV408','懒小羊':'BV426','清新文艺女声':'BV428','鸡汤女声':'BV403','智慧老者':'BV158','慈爱姥姥':'BV157','说唱小哥':'BR001','活力解说男':'BV410','影视解说小帅':'BV411','解说小帅-多情感':'BV437','影视解说小美':'BV412','纨绔青年':'BV159','直播一姐':'BV418','反卷青年':'BV120','沉稳解说男':'BV142','潇洒青年':'BV143','阳光男声':'BV056','活泼女声':'BV005','小萝莉':'BV064','奶气萌娃':'BV051','动漫海绵':'BV063','动漫海星':'BV417','动漫小新':'BV050','天才童声':'BV061','广告配音促销男声':'BV401','促销女声':'BV402','磁性男声':'BV006','新闻女声':'BV011','新闻男声':'BV012','教育场景知性姐姐-双语':'BV034','温柔小哥':'BV033','天才少女':'BV421',}
